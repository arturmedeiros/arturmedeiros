<template>
  <div>
    <h2 class="uppercase text-xs font-semibold text-gray-400 mb-4">MEUS LINKS</h2>
    <div class="space-y-5">
      <NuxtLink
        v-for="link in links"
        :key="link.icon"
...
const links = [
  {
    name: "Linkedin",
    url: "https://www.linkedin.com/in/arturjmedeiros/",
    icon: "mdi:linkedin",
  },
  {
    name: "GitHub",
    url: "https://github.com/arturmedeiros",
    icon: "mdi:github",
  },
  {
    name: "Instagram",
    url: "https://www.instagram.com/arjosweb",
    icon: "mdi:instagram",
  },
  {
    name: "Site da ARJOS",
